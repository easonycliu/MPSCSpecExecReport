...
* Run protocals ckks and EMP-Toolkits only
...
* Remove these evaluations:
	* Parameter sensitivity experiments
	* Senate workload experiments
	* Overhead of touch API and Slab allocator
	* Overhead of speculation
* Add these evaluations:
	* Compare performance of osprey w/ annotation and osprey w/o annotation
	* Compare average CPU usage per application thread of osprey w/ annotation and osprey w/o annotation
